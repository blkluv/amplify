...
export default function AuditLogsCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
  ...
  const resetStateValues = () => {
    ...
    setOpType(initialValues.opType);
    setErrors({});
  };
  const validations = {
    model: [],
    ...
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await DataStore.save(new AuditLogs(modelFields));
          if (onSuccess) {
      ...
      {...getOverrideProps(overrides, "AuditLogsCreateForm")}
      {...rest}
    >
      <TextField
        label="Model"
