...
export default function OrderUpdateForm(props) {
  ...
  const resetStateValues = () => {
    const cleanValues = orderRecord
      ? { ...initialValues, ...orderRecord, customerID }
      : initialValues;
    setShippingAddress(
      typeof cleanValues.shippingAddress === "string"
        ? cleanValues.shippingAddress
        : JSON.stringify(cleanValues.shippingAddress)
    );
    setBillingAddress(
  ...
  React.useEffect(() => {
    const queryData = async () => {
      ...
      const customerIDRecord = record ? await record.customerID : undefined;
      setCustomerID(customerIDRecord);
    };
    queryData();
  }, [idProp, orderModelProp]);
  React.useEffect(resetStateValues, [orderRecord, customerID]);
